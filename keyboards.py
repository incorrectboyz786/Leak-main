...
async def raw_send(chat_id, text, kb_rows=None, parse_mode="HTML", reply_to=None):
...
def rows_gen_menu():
    return [
        [{"text": "🎲  Generate from BIN",
          "callback_data": "noop", "copy_text": {"text": "/gen "}}],
        [{"text": "⚡  Extrapolate Card",
          "callback_data": "noop", "copy_text": {"text": "/extrap "}}],
        [{"text": "↪️  Back",           "callback_data": "back_start"}],
    ]
...
def rows_bin_menu():
    return [
        [{"text": "🔍  Lookup BIN",
          "callback_data": "noop", "copy_text": {"text": "/bin "}}],
        [{"text": "↪️  Back",           "callback_data": "back_start"}],
    ]
...
def rows_vbv_menu():
    return [
        [{"text": "🛡  Check VBV/3DS",
          "callback_data": "noop", "copy_text": {"text": "/vbv "}}],
        [{"text": "↪️  Back",           "callback_data": "back_start"}],
    ]

def rows_sk_menu():
    return [
        [{"text": "🔑  Check Stripe SK",
          "callback_data": "noop", "copy_text": {"text": "/sk "}}],
        [{"text": "↪️  Back",           "callback_data": "back_start"}],
    ]

def rows_plan_menu(plan_key: str = 'free'):
    rows = []
    if plan_key in ('free', 'trial'):
        rows.append([{"text": "🎫  Redeem Key",      "callback_data": "redeem_menu"}])
        rows.append([{"text": "💬  Buy Premium",     "url": f"https://t.me/{OWNER_USERNAME}"}])
    rows.append([{"text": "↪️  Back",                "callback_data": "back_start"}])
    return rows

def rows_redeem_menu():
    return [
        [{"text": "↪️  Back",           "callback_data": "back_start"}],
    ]
...
def rows_admin():
    return [
        ...
        [{"text": "📢  Broadcast",      "callback_data": "admin_broadcast_info"},
         {"text": "📡  Proxy Pool",     "callback_data": "admin_proxy_pool"}],
...
def rows_admin_keys():
    return [
        [{"text": "🎫  Gen Trial Key",   "callback_data": "admin_gen_trial_key"},
         {"text": "✅  Gen Premium Key", "callback_data": "admin_gen_premium_key"}],
        [{"text": "📋  List Keys",       "callback_data": "admin_list_keys"}],
        [{"text": "↪️  Back",            "callback_data": "admin_panel"}],
    ]
